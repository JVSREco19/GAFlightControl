...
population = 1000
mutationRate = 100  # Chance de mutação; quanto maior, mais chance
...
def criar_graficos_juntos(valores_list):
    num_graficos = len(valores_list)
...
def tournament():
    ...
    for i in range(population):
        ...
        for j in range(tournamentConstant):
            randomIndividual = random.choice(populationList)
            tournamentAuxiliarList.append(randomIndividual)
...
criar_graficos_juntos(listOfValuesToPlot)
